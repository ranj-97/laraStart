    ...
    <div id="app" class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="./img/r.png" alt="Ranj Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Ranj</span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <router-link to="/developer" class="nav-link">
                                ...
                                --}}
                                <i class="nav-icon white fas fa-cogs"></i>
                                <p>
                                   Management
                                </p>
                            </router-link>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2020-2021 <a href="#">Ranj</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
